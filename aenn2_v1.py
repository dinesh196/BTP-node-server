...
encoder_eval.load_state_dict(torch.load(os.path.join("/Users/dineshchavan/Desktop/BTP-node-server/", encoder_model_name)))
decoder_eval.load_state_dict(torch.load(os.path.join("/Users/dineshchavan/Desktop/BTP-node-server/", decoder_model_name)))
encoder_eval.cpu().eval()
decoder_eval.cpu().eval()
